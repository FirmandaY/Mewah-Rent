                    ...
                    <div class="col-md-12">
                        <div class="titlepage">
                            <div class="banner_main">
                                <div class="container">
                                   <div class="row">
                                        <div class="detailimg1 col-md-7">
                                            <img src="images/asusrog.png" width="800px" height="900px">
                                        </div>
                                        <div class="deskripsi col-md-4 padding_right1">
                                            <!--ini adalah wadah untuk bentuk banner utama-->
                                            <h1 class="titleDetail">Specification</h1>
                                            <!--<h1>Tempatnya Sewa</h1>-->
                                            <h3 class="detailcomment1" align="left">Asus ROG Strix G15 G513QR-R737D6T-O</h3>
                                            <p class="detailcomment1" align="left">
         ...
         <div id="contact" class="footer">
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="cont_call">
                        <h6> <strong class="multi">Our Office</strong><br>
                           Jl. Lembarawa, Sawah, Krasak, Kec. Brebes, Kabupaten Brebes, Jawa Tengah 52219
                        </h6>
                        <h5> <strong class="multi">Contact Us</strong><br>
                           0823-2288-1233
                        </h5>
                     </div>
                  </div>
