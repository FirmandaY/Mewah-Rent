                  ...
                  <section class="faq">
                     <div class="faq-left">
                        <!-- FAQ -->
                           ...
                           <li>
                              <label for="q3">Q: Bagaimana cara saya dapat meminjam? </label> <input name="question" id="q3" type="checkbox" value="">
                              <div class="answer">
                                 <p>Maecenas justo erat, consectetur vel pellentesque quis, pharetra id tellus. Morbi ut nibh nisi. Vestibulum porta sollicitudin erat et convallis. u</p>
                              </div>
                           </li>
                           ...
                           <li>
                              <label for="q4">Q: Bagaimana jika barang rusak saat saya pakai? </label> <input name="question" id="q4" type="checkbox" value="">
                              <div class="answer">
                                 <p>Maecenas justo erat, consectetur vel pellentesque quis, pharetra id tellus. Morbi ut nibh nisi. Vestibulum porta sollicitudin erat et convallis. u</p>
                              </div>
                           </li>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="cont_call">
                        ...
                        <h5><strong class="address"><img src="images/placeholder(1).png" height="30" width="30">
