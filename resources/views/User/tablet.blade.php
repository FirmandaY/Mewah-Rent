...
<html lang="en">
   ...
   <!-- body -->
    <body class="main-layout">
        ...
        <header>
            ...
            <div  class="head_top">
                            ...
                            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                                ...
                                <div class="collapse navbar-collapse" id="navbarsExample04">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="index.html"> <b> Product </b></a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="banner_main">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-10 padding_right1">
                                <!--ini adalah wadah untuk bentuk banner utama-->
                                <h1 class="titleAbout">Tablet</h1>
      ...
      <!-- end banner -->
      <!-- best -->
      <div id="productPC1" class="best">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>Sewa Multiplayer</h2>
                     <span>
                        Dapatkan penawaran terbaik dengan rental Multiplayer!
                        Berikut adalah kategori persewaan Multiplayer yang kami sediakan.
                     </span>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-4" onclick="window.location='produkDetail.html';">
                  <div class="best_box">
                     <h4>Team</h4>
      ...
      <!--Multiplayer Rent Selesai-->
      <!--Solo Player Rent-->
      <div id="productPC2" class="best">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>Sewa Solo Player</h2>
                     <span>
                        Solo player? jangan khawatir! Masih banyak penawaran kami!
                        Di Mewah Rent semua bisa!
                        Berikut adalah kategori persewaan solo yang kami sediakan.
                     </span>
                  </div>
               </div>
            </div>
